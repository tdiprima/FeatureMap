...
describe("'tooltip_split' Option tests", function () {
  let testSlider; const sliderId = 'tooltipedSlider'
  let $slider; let $tooltipMain; let $tooltipMin; let $tooltipMax
  const sliderOptions = { id: sliderId, value: [0, 10], tooltip: 'always' } // for the sake of testing, always display the tooltip
