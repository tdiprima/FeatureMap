    ...
    describe('Touch Events', function () {
      ...
      */
      ...
      beforeEach(function () {
        ...
        const dummyTouchEvent = document.createEvent('MouseEvents')
      ...
      it("slider should not bind multiple touchstart events after calling 'refresh'", function (done) {
        ...
        const handleElem = $('#testSlider2').prev('div.slider').find('.slider-handle:first').get(0)
