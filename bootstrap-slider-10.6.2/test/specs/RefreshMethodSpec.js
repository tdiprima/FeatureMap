describe('refresh() Method Tests', function () {
  ...
  let $testSlider
  let options
  let initialValue, initialRangeValue
  let newValue, newRangeValue
  ...
  it('does not convert a non-range slider into a range slider when invoked', function () {
    ...
    const initialValue = testSlider.getValue()
    let sliderIsRangeValue = initialValue instanceof Array
    ...
    const afterRefreshValue = testSlider.getValue()
